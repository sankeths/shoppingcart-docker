...
if (!isset($_SERVER['PHP_AUTH_USER']) && !isset($_SERVER['PHP_AUTH_PW'])) {
    ...
    print "Oops! You are not logged in.\n";
    exit;
} else {
            ...
            if ($count == 1) {
                ...
                if ($_GET['order_id']!=0) {
                    ...
                    //foreach ($data1 as $key => $value) {
                        if ($key) {
                            $sql = "SELECT o.id,o.customer_id,c.name,o.total_price,o.status,oi.order_id,oi.quantity,p.price,p.name,o.paymenttype
                            ...
                            if (sizeof($emparray) > 0) {
                            	...
                            	header("Content-type:application/xml");
                            	echo "<Error>No orders found</Error>";
                            }
                            }
                        }
                    //}
